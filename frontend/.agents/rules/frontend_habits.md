---
description: 前端工程专属排版、架构、组件库与 Composition API 铁律 (自动生效)
always_on: true
---

# 前端核心排版、架构、组件库与 Composition API 铁律

在编写或修改 `frontend/` 目录下的任何 Vue / TypeScript / CSS / HTML 代码时，强制执行以下 7 项规范：
...
5. **特性/领域内聚与就近原则 (Feature-First & Colocation)**：
...
7. **大厂级 Composition API 组织与 Composable 4 大铁律**：
